...
final class PermitTravailRefuserProcessor implements ProcessorInterface
{
    ...
    public function process(mixed $data, Operation $operation, array $uriVariables = [], array $context = []): mixed
    {
        ...
        if ($commentaire === '') {
            throw new BadRequestHttpException('permit_travail.commentaire_required_pour_refus');
        }
        ...
        $this->notificationService->notifierRefus($permit, $commentaire);
