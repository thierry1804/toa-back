...
#[ORM\Entity(repositoryClass: PermitTravailPdfRepository::class)]
#[ORM\Table(name: '`permit_travail_pdf`')]
class PermitTravailPdf
{
    #[ORM\Id]
    ...
    #[ORM\Column(length: 20, enumType: StatutPermitTravailPdf::class)]
    private StatutPermitTravailPdf $statut = StatutPermitTravailPdf::EN_COURS;
    ...
    public function getStatut(): StatutPermitTravailPdf
    {
        return $this->statut;
    }

    public function setStatut(StatutPermitTravailPdf $statut): static
    {
        $this->statut = $statut;
