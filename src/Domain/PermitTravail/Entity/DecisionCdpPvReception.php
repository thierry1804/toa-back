...
#[ORM\Entity(repositoryClass: DecisionCdpPvReceptionRepository::class)]
#[ORM\Table(name: '`decision_cdp_pv_reception`')]
class DecisionCdpPvReception
{
    #[ORM\Id]
    ...
    #[ORM\Column(length: 10, enumType: DecisionCdpPv::class)]
    #[Groups(['permit_travail:read'])]
    private ?DecisionCdpPv $decision = null;
    ...
    public function getDecision(): ?DecisionCdpPv
    {
        return $this->decision;
    }

    public function setDecision(DecisionCdpPv $decision): static
    {
