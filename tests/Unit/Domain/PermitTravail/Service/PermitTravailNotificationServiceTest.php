...
class PermitTravailNotificationServiceTest extends TestCase
{
    private UserRepository&MockObject $userRepository;
    private MailerInterface&MockObject $mailer;
    private PermitTravailNotificationService $service;

    protected function setUp(): void
    {
        $this->userRepository = $this->createMock(UserRepository::class);
        $this->mailer = $this->createMock(MailerInterface::class);
        $this->service = new PermitTravailNotificationService(
            $this->mailer,
            $this->userRepository,
            new NullLogger(),
        );
    ...
    public function testNotifierSoumissionNotifiesEveryHseUserWhateverTheEntreprise(): void
    {
        ...
        $this->service->notifierSoumission(new PermitTravail());
    ...
    public function testNotifierHseResoumissionNotifiesEveryHseUserWhateverTheEntreprise(): void
    {
        ...
        $this->service->notifierHseResoumission(new PermitTravail(), 2);
