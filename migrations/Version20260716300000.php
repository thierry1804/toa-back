...
final class Version20260716300000 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Ensure user columns exist: numero_registre_commerce, siege_social, qualite_representant, signature_path';
    }
